...
--[[ new calcs unsure how to impliment but want to leave here for future
  local FlatArmorPenetration = ((Lethality/100) * (0.6 + 0.4 * source.levelData.lvl / 18))
...
local DamageLibTable = {
  ...
  ["Blitzcrank"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({90, 140, 190, 240, 290})[level] + 1.2 * source.ap end},
  ...
  ["Caitlyn"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({50, 90, 130, 170, 210})[level] + ({1.3, 1.45, 1.6, 1.75, 1.9})[level] * source.totalDamage end},
  ...
  ["Cassiopeia"] = {
    ...
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return 48 + 4 * myHero.levelData.lvl + 0.1 * source.ap + (HasPoison(target) and ({20, 40, 60, 80, 100})[level] + 0.6 * source.ap or 0) end},
  ...
  ["Kennen"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({85, 130, 175, 220, 265})[level] + 0.8 * source.ap end},
  ...
  ["Leblanc"] = {
    ...
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({75, 110, 145, 180, 215})[level] + 0.6 * source.ap end},
  ...
  ["Nami"] = {
    ...
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({25, 35, 50, 65, 80})[level] + 0.2 * source.ap end}, --per tick
  ...
  ["Shen"] = {
    ...
    {Slot = "Q", Stage = 2, DamageType = 2, Damage = function(source, target, level) local dmg = ({4, 4.5, 5, 5.5, 6})[level] + (0.02 * source.ap / 100) * target.maxHealth / 100; if target.type == Obj_AI_Hero then return dmg end; return math.min(({30, 50, 70, 90, 110})[level]+dmg, ({75, 100, 125, 150, 175})[level]) end}, -- enhanced if collided with champion
  ...
  ["TahmKench"] = {
    ...
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({100, 250, 400})[level] + (0.15 + (0.05 / 100 * source.ap) * target.maxHealth) end}, --2nd cast damage "Regurgitate"
  ...
  ["TwistedFate"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({60, 100, 140, 180, 220})[level] + 0.7 * source.ap end},
  ...
  ["Zeri"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({1.42, 2.14, 2.86, 3.57, 4.29})[level] + 0.1571 * source.bonusDamage end}, --per bullet
    {Slot = "Q", Stage = 2, DamageType = 1, Damage = function(source, target, level) return ({10, 15, 20, 25, 30})[level] + 1.1 * source.totalDamage end}, --total 
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({40, 75, 110, 145, 170})[level] + source.totalDamage + 0.6 * source.ap end},
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({150, 250, 300})[level] + 0.8 * source.bonusDamage + 0.8 * source.ap end}, --Nova damage
    {Slot = "R", Stage = 2, DamageType = 1, Damage = function(source, target, level) return ({10, 15, 20})[level] + 0.15 * soure.ap end}, -- on hit bonus magic damage
  },
  ["Ziggs"] = {
